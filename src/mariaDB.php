...
<section>
    ...
    <h6 class="reduzido">Testado no Linux Mint <span style="font-family: 'Noto Sans', sans-serif;">19.1</span> Tessa.</h6>
    ...
    <p class="comum">E outros comandos &uacute;teis...</p>
    <p class="comum">No resultado procure a linha 'Active:'.</p>
    <p class="comum">Para sair pressione a tecla 'q'.</p>
    <p class="miniatura">C&oacute;digo</p>
    <div class="box sombra">
        <code>$ sudo service mysql status</code>
    </div>

    <p class="comum">Parar o mariaDB.</p>
    <p class="miniatura">C&oacute;digo</p>
    <div class="box sombra">
        <code>$ sudo service mysql stop</code>
    </div>

    <p class="comum">Iniciar o mariaDB.</p>
    <p class="miniatura">C&oacute;digo</p>
    <div class="box sombra">
    ...
    <div class="box sombra">
        ...
        You can turn off this feature to get a quicker startup with -A<br>
            <br>
            <b>Database changed</b><br>
        </p>
        <span class="azul">MariaDB [(none)]&gt;</span> <code>update user set plugin='' where User='root';</code><br>
        <p style="font-size: 11px" class="verde">
            <b>Query OK, 1 row affected (0.03 sec)<br>
                Rows matched: 1  Changed: 1  Warnings: 0</b><br>
            <br>
        </p>
        <span class="azul">MariaDB [(none)]&gt;</span> <code>flush privileges;</code><br>
        <p style="font-size: 11px" class="verde">
            <b>Query OK, 0 rows affected (0.00 sec)</b><br>
            <br>
        </p>
        <span class="azul">MariaDB [(none)]&gt;</span> <code>SET PASSWORD FOR 'root'@'localhost' = PASSWORD('SuaSenha');</code><br>
        <p style="font-size: 11px" class="verde">
            <b>Query OK, 0 rows affected (0.00 sec)</b><br>
            <br>
        </p>
    ...
    <p class="comum">Digite a senha que voc&ecirc; escolheu e colocou em lugar de <b>SuaSenha</b> no comando
    ...
    <div class="box sombra">
        ...
        <span class="azul">Enter password:</span>
        <p style="font-size: 11px" class="verde">
            <b>Welcome to the MariaDB monitor.  Commands end with ; or \g.<br>
            ...
            <br>
                Type 'help;' or '\h' for help. Type '\c' to clear the current input statement.</b><br>
            <br>
        </p>
        &gt;
    </div>
    ...
    <p class="miniatura">C&oacute;digo</p>
    <div class="box sombra">
        <code>&gt; create database testes;</code>
    </div>

    <p class="comum">Deletar uma base de dados, chamada 'testes'.</p>
    <p class="miniatura">C&oacute;digo</p>
    <div class="box sombra">
        <code>&gt; drop database testes;</code>
    </div>
    ...
    <p class="comum">Criar um novo usu&aacute;rio.</p>
    <p class="miniatura">C&oacute;digo</p>
    <div class="box sombra">
        <code>&gt; CREATE USER 'NomeDoUsuario'@'localhost' IDENTIFIED BY 'SenhaDoUsuario';</code>
    </div>
