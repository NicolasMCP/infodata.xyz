...
<!--NetBeans-->
    ...
    <h3>Mudar HTML5 padr&atilde;o</h3>
    ...
    <p class="comum">Reindenta o c&oacute;digo da janela atual</p>
    <p class="miniatura">Procedimento</p>
    <div class="box sombra">
        Pressione simultaneamente as teclas &gt;&gt;--&gt; Alt + Shift + F
    </div>

    <h5>Ativar quebra autom&aacute;tica de linha</h5>
