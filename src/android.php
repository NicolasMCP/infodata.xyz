...
?>
    ...
    <!--android-->
        ...
        <div class="box sombra">
            ...
            Adicionar a Lista de Rejei&ccedil;&atilde;o.<br/>(Fa&ccedil;a isso para cada N&uacute;mero que Desejar Rejeitar.)
        </div>
        ...
        <div class="box sombra">
            ...
            Bloqueio de Chamadas &gt; Lista de Bloqueio<br/>(Fa&ccedil;a isso para cada Contato que Desejar Bloquear.)
        </div>

        <p class="comum">Como fazer no Android <strong>Samsung Neo</strong></p>
        <p class="miniatura">Procedimento</p>
        <div class="box sombra">
            Telefone &gt; Contatos &gt; Clicar no Contato<br/>
            &gt; Detalhes &gt; [pontinhos, menu]<br/>
            Bloquear Contato<br/>(Fa&ccedil;a isso para cada Contato que Desejar Bloquear.)
        </div>
    </section>
